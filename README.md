...
**Status: skeleton (M0).** No measurements published yet. The table schema,
measurement policy, and coverage manifest are in place; benchmark families land
in milestones M1–M5, completeness audit and paper at M6.
