...
\caption{Left: dependent pointer-chase latency by footprint; the
three plateaus are the levels of \cref{tab:memory}. Right: the same
...
\texttt{ATOMS.ADD}; there is no shared reduction opcode), while
