...
and \texttt{FLO} measure exactly 15 cycles, \texttt{HFMA2} 6.19 cycles,
both on prior.
Three deviations publish: \texttt{IMAD} at 4.11 cycles against a prior of
5 ($-17.8\%$), \texttt{DADD} at 44.0 cycles against ${\sim}48$, and
\texttt{DFMA} at 48.0 cycles against ${\sim}54$. Rows with no published prior
...
(16.7 to 528 cycles for 1-way to 32-way, within 5\% of $k\times$
throughout), and the predicated equivalent
costs precisely the uniform 16.7 cycles. If-conversion is free at this
