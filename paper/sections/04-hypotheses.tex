...
peer-written lines at 2.59~\textmu s against 1.14~\textmu s
steady-state, and the
visibility-aware composition closes the gate at both sizes ($-4.5\%$ at
4~KiB, $-10.3\%$ at 20~KiB). The registered comparison therefore applies
across its stated domain: 4.92~\textmu s against a bar of
10.54~\textmu s at 4~KiB (margin 2.1$\times$), 7.94~\textmu s against
12.51~\textmu s at 20~KiB (margin 1.6$\times$).
...
in-situ launches average 3.13~\textmu s against the row's
1.56~\textmu s, and four
